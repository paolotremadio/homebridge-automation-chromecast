...
ControlChromecastPlatform.prototype.scanAccesories = function () {
  ...
  let addChromecast = function(device){
    if(device && device.txtRecord && ['Chromecast', 'Chromecast Audio', 'Google Cast Group', 'Google Nest Hub', 'Lenovo Smart Clock', 'Google Home', 'Google Home Mini'].indexOf(device.txtRecord.md) !== -1){
